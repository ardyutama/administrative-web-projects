...
import { Activity, Ban, MinusCircle, ChevronRight, PencilIcon } from "lucide-react"
...
export const columns: ColumnDef<VirtualMachine>[] = [
    {
        ...
        cell: ({ row }) => (
            ...
            >
                <ChevronRight className={`h-4 w-4 ${row.getIsExpanded() ? 'rotate-90' : 'rotate-0'} transition-all`}/>
            </button>
        )
    },
    {
